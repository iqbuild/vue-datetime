<template>
  <div class="vdatetime" :class="wrapperClass">
    <input ref="input" v-bind="$attrs" v-on="$listeners" type="text" :placeholder="placeholder" :value="inputValue" :class="inputClass" :required="required" @click="open" @focus="open" />
